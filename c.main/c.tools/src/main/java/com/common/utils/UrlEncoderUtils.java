...
public class UrlEncoderUtils {
    ...
    public static void main(String[] args) {
		System.out.println(UrlEncoderUtils.hasUrlEncoded("WC6rR8WCq%2By5VyHSf0DLDqg8Q%2FnOT2ahiWcwHwm30O4oRNyHZmDXZLVozIA6TJTY"));
		System.out.println(UrlEncoderUtils.hasUrlEncoded("6UEVJtaMEsoPxUhB+pJCB10qwxJK0CySaSKbMeNXX+GTOmgeVT/6I749RNbySw0P"));
	}
}
